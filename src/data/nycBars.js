...
export const NYC_BARS = {
  ...
  // Neil's home turf — deep, cross-referenced (≥2 sources each) soccer bars SOUTH
  // OF 14TH ST, grouped by zone. TVs required; watchParty flags organized World
  // Cup watch parties. Addresses individually verified below 14th St.
  downtownPicks: [
    // ── West & Greenwich Village · Hudson Square ──
    { name: 'The Red Lion', area: 'Greenwich Village, Manhattan', vibe: '40-year Bleecker St football HQ', why: '151 Bleecker — 10+ HD screens, opens 11am with the kitchen on all day, every fixture group stage → final. Reservations for the biggest matches; walk-ins otherwise.', source: 'https://www.nyctourism.com/articles/soccer-bars-in-nyc/', watchParty: true },
    { name: 'Josie Woods Pub', area: 'Greenwich Village, Manhattan', vibe: 'Below-street Irish sports pub', why: '11 Waverly Pl, down a flight near Washington Sq — 14 HD TVs, pool & darts, genuine football crowds and electric energy for big matches. Opens early for kickoffs.', source: 'https://josiewoodsnyc.com/', watchParty: true },
    { name: 'The Spaniard', area: 'West Village, Manhattan', vibe: 'Swanky-but-rowdy gastropub', why: '190 W 4th — fills three-deep for marquee fixtures on a big screen + TVs throughout, doors 10:30am, proper bar food and pitchers.', source: 'https://www.theinfatuation.com/new-york/reviews/the-spaniard', watchParty: true },
    { name: 'Fiddlesticks Pub', area: 'West Village, Manhattan', vibe: 'Big three-room Irish pub', why: '56 Greenwich Ave — three rooms, 5 HD screens + 2 projectors showing all major matches, weekend DJs and roomy enough for a group.', source: 'https://www.nyctourism.com/nightlife/fiddlesticks-pub-grill/', watchParty: false },
    { name: 'Wilfie & Nell', area: 'West Village, Manhattan', vibe: 'Dark, cozy local with the sound on', why: '228 W 4th — TVs everywhere and sound on for games; a comfortable matchday pick that’s less of a scene. Walk-ins only.', source: 'https://www.theinfatuation.com/new-york/reviews/wilfie-nell', watchParty: false },
    { name: 'The Lavaux', area: 'West Village, Manhattan', vibe: 'Swiss wine & fondue bar', why: '630 Hudson — nation-specific watch parties (Switzerland, USA) with game-day food/drink packages. Refined, supporters-club alternative; reserve ahead.', source: 'https://www.theinfatuation.com/new-york/guides/where-to-watch-the-world-cup-nyc', watchParty: true },
    { name: 'Houston Hall', area: 'Hudson Square, Manhattan', vibe: 'Cavernous beer hall, 12-ft screens', why: '222 W Houston — a vast beer hall with jumbo screens and communal tables, running dedicated WC parties and pre-booked group tables. Built for big crowds.', source: 'https://www.houstonhallny.com/world-cup-watch-parties-west-village-new-york-city/', watchParty: true },
    { name: "SOB's", area: 'Hudson Square, Manhattan', vibe: 'Wild national-team watch parties', why: "204 Varick — free RSVP watch parties on a 16'×18' 4K LED wall + 5 screens, DJ sets and after-parties (Brazil/Mexico/USA/Colombia). The closest thing downtown to a stadium crowd. 21+, $30 min.", source: 'https://sobs.com/worldcup/', watchParty: true },
    // ── East Village · NoHo · Bowery · Lower East Side ──
    { name: '11th Street Bar', area: 'East Village, Manhattan', vibe: 'Liverpool supporters HQ, Anfield energy', why: "510 E 11th — home of LFCNY since 2003; fans pack in for 'You'll Never Walk Alone' and an Anfield atmosphere. Opens early for European football.", source: 'https://firsttouchonline.com/the-11th-street-bar-east-village/', watchParty: true },
    { name: 'The Grafton', area: 'East Village, Manhattan', vibe: 'Family-run Irish pub, backyard screens', why: '126 1st Ave — opens early for European soccer with Irish-breakfast brunch, a TV at every sidewalk table and screens in the backyard (reserve by email).', source: 'https://www.thegraftonnyc.com/', watchParty: true },
    { name: 'The Hairy Lemon', area: 'East Village (Alphabet City), Manhattan', vibe: 'Rambunctious Irish sports bar', why: '28 Ave B — 20+ TVs showing EPL & Champions League, pool, darts and loud matchday energy. Featured by The Infatuation and Time Out.', source: 'https://www.theinfatuation.com/new-york/guides/best-sports-bars-nyc', watchParty: false },
    { name: 'Bar Bianchi', area: 'East Village, Manhattan', vibe: 'Stylish Milanese aperitivo bar', why: '5 Ave A — a design-forward Italian spot that rolls out TVs for the World Cup; aperitivo and Italian food with the match on. Atmosphere over a scrum.', source: 'https://www.tastingtable.com/2192375/best-nyc-bars-watch-world-cup/', watchParty: true },
    { name: 'Sláinte', area: 'Bowery, Manhattan', vibe: 'Bowery World Cup HQ, group-friendly', why: '304 Bowery — officially listed Bowery WC HQ: a projector + 14 TVs, 24 draught lines and a built-in soccer crowd. Reserve a table for big matches.', source: 'https://slaintebarnyc.com/', watchParty: true },
    { name: 'one4one Sports Club & Lounge', area: 'Lower East Side, Manhattan', vibe: 'Upscale private-screening-room lounge', why: '141 Chrystie — a polished lounge broadcasting all 104 matches with table service, open-bar packages and a pool room for buyouts. More refined than a dive.', source: 'https://www.one4onenyc.com/', watchParty: true },
    { name: 'Hair of the Dog', area: 'Lower East Side, Manhattan', vibe: 'Dark, high-energy dive sports bar', why: '168 Orchard — 17+ HDTVs + 3 projection screens, big tournament crowds, cheap pitchers and bar food; strangers chatting by halftime.', source: 'https://www.theinfatuation.com/new-york/guides/best-sports-bars-nyc', watchParty: false },
    { name: "Rocco's Sports & Recreation", area: 'NoHo, Manhattan', vibe: 'Vintage sports bar with a mini jumbotron', why: "1 W 3rd — one of downtown's newer sports bars: TVs throughout incl. a mini 'jumbotron,' large-format cocktails and bookable game-day tables.", source: 'https://noho.nyc/now-in-noho-roccos-sports-and-recreation/', watchParty: false },
    // ── SoHo · Tribeca · FiDi · Seaport ──
    { name: 'Félix', area: 'SoHo, Manhattan', vibe: 'French bistro turned Les Bleus party', why: '340 West Broadway (since 1992) — the French crowd’s spot, adding screens for the World Cup with crowds spilling into the street when France play.', source: 'https://www.nyctourism.com/articles/where-to-watch-soccer-felix-french-restaurant/', watchParty: true },
    { name: 'Brickyard Craft Kitchen & Bar', area: 'Tribeca, Manhattan', vibe: 'Cavernous sports bar, ~40–50 screens', why: '23 Park Pl — video walls everywhere (catch multiple games at once) running a ticketed series across all 104 matches with dedicated USA-match parties.', source: 'https://www.nyctourism.com/nightlife/brickyard-craft-kitchen-and-bar/', watchParty: true },
    { name: "Carragher's", area: 'Financial District, Manhattan', vibe: "Jamie Carragher's Liverpool pub", why: '17 John St — two floors of HD screens with the volume up, every World Cup fixture; pro players occasionally drop in. The most genuine football pub in FiDi.', source: 'https://downtownny.com/news/where-to-watch-world-cup-bars-downtown-nyc/', watchParty: true },
    { name: 'Stout FiDi', area: 'Financial District, Manhattan', vibe: 'Spacious official NYCFC bar partner', why: '90 John St — the official NYCFC bar partner; 20-ft ceilings, tables spread out and plenty of HD screens, so you get the game without a crush. Every WC match.', source: 'https://www.stoutnyc.com/event/official-bar-new-york-city-fc/', watchParty: true },
    { name: 'Blue Haven South', area: 'Financial District, Manhattan', vibe: 'Mega-screen party bar + rooftop', why: '121 Fulton — 50+ TVs, DJs and an open-air rooftop; every game with Stella/Modelo activations and limited-edition World Cup chalices. Leans party.', source: 'https://downtownny.com/news/where-to-watch-world-cup-bars-downtown-nyc/', watchParty: true },
    { name: 'Continental Sports Lounge', area: 'Financial District, Manhattan', vibe: 'Two-level screen overload', why: "82 Beaver St (the 'John Wick' building) — 70–80+ TVs across two levels so you can run multiple group-stage games at once, with beer-bucket specials.", source: 'https://www.nyctourism.com/nightlife/continental-sports-lounge/', watchParty: true },
    { name: 'Old Mates Pub', area: 'South Street Seaport, Manhattan', vibe: "Three-floor Aussie pub, Socceroos HQ", why: "170 John St — the city's de facto Socceroos HQ (an official watch-party host that's drawn 500+ with a Tim Cahill appearance); 60-ft bar, big screens across three floors.", source: 'https://www.theinfatuation.com/new-york/guides/where-to-watch-the-world-cup-nyc', watchParty: true },
    { name: 'Socceroof Wall Street', area: 'Financial District, Manhattan', vibe: 'Indoor five-a-side + watch parties', why: '28 Liberty — a ~20,000 sq ft indoor soccer venue (four pitches) with a full bar running stadium-production watch parties: book a kick-around, then watch the match.', source: 'https://downtownny.com/news/socceroof-world-cup-2026/', watchParty: true },
    { name: 'London Martin & Co.', area: 'Financial District, Manhattan', vibe: 'English pub on cobblestoned Stone St', why: '6 Stone St — a British-themed bar doing live soccer + World Cup parties on FiDi’s most atmospheric block; England’s group games are the big draw.', source: 'https://downtownny.com/news/london-martin-co-world-cup/', watchParty: true },
  ],
}
